...
class TestDragAndDrop:
	...
	def test_drag_and_drop(self):
		left_box = WebDriverWait(self.driver, 2).until(EC.element_to_be_clickable((By.ID, 'column-a')))
		right_box = WebDriverWait(self.driver, 2).until(EC.element_to_be_clickable((By.ID, 'column-b')))
